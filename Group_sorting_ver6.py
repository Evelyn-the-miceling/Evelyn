...
ratio_boy_girl = number_of_male/number_of_female # To handle one-gendered groups
...
all_subgroups = Groups_of_5(Male_Students_sorted, Female_Students_sorted, ratio_boy_girl)

#Debugging function
""" print(len(all_subgroups))
